...
const projectTitle = "Screen Translator"
const repoName = "screen-translate"
const githubUser = "bstephe9"

const config: Config = {
  title: projectTitle,
  tagline: 'Translate text on screen in real-time',
